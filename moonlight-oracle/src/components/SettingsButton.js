  ...
  return (
    <>
      <button
        ...
        className="fixed top-5 right-6 z-30 w-10 h-10 rounded-full bg-navy-light/80 border border-indigo/20 flex items-center justify-center text-indigo/50 hover:text-silver/60 hover:border-indigo/40 transition-all cursor-pointer backdrop-blur-sm"
      >
